...
with open('../../popQA/data/popQA.json', 'r', encoding='utf-8') as file:
    data = json.load(file)
...
with open('../../popQA/data/popQA.jsonl', 'w', encoding='utf-8') as file:
...
# Write the extracted entries to a new JSON Lines file
with open('LAMA_UHN.jsonl', 'w', encoding='utf-8') as file:
    for entry in extracted_data:
        file.write(json.dumps(entry,  ensure_ascii=False) + '\n')
