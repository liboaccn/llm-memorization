...
def plotting(variance1, variance2, mean1, mean2, random_mean1, random_variance1, random_mean2, random_variance2,
    ...
    plt.savefig('../figure/celebrity_prob_rand_{}.pdf'.format(model_name_or_path), dpi=300, bbox_inches='tight')
    # 显示图形
    plt.show()
...
def get_numbers(model):
    if model == 'llama2-13b':
        ...
        random_mean1, random_variance1 = 0.8854, 0.0040
        random_mean2, random_variance2 = 0.8845, 0.0039
    else:
