...
mem_counts_13b = np.array([31, 66, 52, 37, 463, 26, 8])
non_mem_counts_13b = np.array([2, 6, 7, 5, 98, 6, 3])
mem_ratios_13b = np.array([0.9393939393939394, 0.9166666666666666, 0.8813559322033898,
                       0.8809523809523809, 0.8253119429590018, 0.8125, 0.7272727272727273])

# categories_7b_chat = ['ADV', 'ADP', 'VERB', 'ADJ', 'NOUN', 'PRON', 'PROPN']
mem_counts_7b_chat = np.array([31, 66, 52, 37, 463, 26, 8])
non_mem_counts_7b_chat = np.array([2, 6, 7, 5, 98, 6, 3])
mem_ratios_7b_chat = np.array([0.9393939393939394, 0.9166666666666666, 0.8813559322033898,
                       0.8809523809523809, 0.8253119429590018, 0.8125, 0.7272727272727273])

# categories_13b_chat = ['ADV', 'ADP', 'VERB', 'ADJ', 'NOUN', 'PRON', 'PROPN']
mem_counts_13b_chat = np.array([31, 66, 52, 37, 463, 26, 8])
non_mem_counts_13b_chat = np.array([2, 6, 7, 5, 98, 6, 3])
mem_ratios_13b_chat = np.array([0.9393939393939394, 0.9166666666666666, 0.8813559322033898,
                       0.8809523809523809, 0.8253119429590018, 0.8125, 0.7272727272727273])
