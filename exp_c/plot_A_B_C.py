...
def plot_slope_graph(context_child, generated_parent, context_parent):
    ...
    s_sim_1, s_sim_2 = [], []
    prob = []
    for i in range(len(cosine_sim_1)):
        prob.append(cosine_sim_2[i] - cosine_sim_1[i])
    ...
    for i in sampled_indices:
        # if not (cosine_sim_2[i] > cosine_sim_1[i]):
        #     print(i)
        #     continue
        s_sim_1.append(cosine_sim_1[i])
        s_sim_2.append(cosine_sim_2[i])
...
def plot_overlapping_density(context_child, generated_parent, context_parent):
    cosine_sim_1 = compute_cosine_similarity(generated_parent, context_child)
    cosine_sim_2 = compute_cosine_similarity(context_parent, context_child)
    ...
    sns.kdeplot(cosine_sim_1, label='(Generated Parent, Context Child)', shade=True, color="r", alpha=0.5)
    sns.kdeplot(cosine_sim_2, label='(Context Parent, Context Child)', shade=True, color="b", alpha=0.5)
    ...
    plt.savefig('overlapping_density.pdf', dpi=300, bbox_inches='tight')
    plt.show()


def plot_violin_density(context_child, generated_parent, context_parent):
    cosine_sim_1 = compute_cosine_similarity(generated_parent, context_child)
    cosine_sim_2 = compute_cosine_similarity(context_parent, context_child)
    ...
    # Plot violin plots
    plt.figure(figsize=(8, 6))
    plt.violinplot([cosine_sim_1, cosine_sim_2], showmeans=True)
    plt.xticks([1, 2], ['(Generated Parent, Context Child)', '(Context Parent, Context Child)'], fontsize=13)
    plt.yticks(fontsize=14)
    plt.ylabel('Cosine Similarity', fontsize=14)
    plt.savefig('violin_density.pdf', dpi=300, bbox_inches='tight')
    plt.show()


def plot_histogram(context_child, generated_parent, context_parent):
    cosine_sim_1 = compute_cosine_similarity(generated_parent, context_child)
    cosine_sim_2 = compute_cosine_similarity(context_parent, context_child)
...
def plot_box_plot(context_child, generated_parent, context_parent):
    ...
    # Plot boxplots
    plt.figure(figsize=(8, 6))
    # plt.boxplot([cosine_sim_1, cosine_sim_2], labels=['(Generated Parent, Context Child)', '(Context Parent, Context Child)'])
    plt.boxplot([cosine_sim_1, cosine_sim_2], labels=['$A$', '$B$'],
...
def plot_violin_euclidean(context_child, generated_parent, context_parent):
    eu_1 = compute_euclidean_distance(generated_parent, context_child)
    eu_2 = compute_euclidean_distance(context_parent, context_child)
    ...
    # Plot violin plots
    plt.figure(figsize=(8, 6))
    plt.violinplot([eu_1, eu_1], showmeans=True)
    plt.xticks([1, 2], ['(Generated Parent, Context Child)', '(Context Parent, Context Child)'], fontsize=13)
    plt.yticks(fontsize=14)
    plt.ylabel('Euclidean Distance', fontsize=14)
    plt.savefig('violin_density_euclidean.pdf', dpi=300, bbox_inches='tight')
    plt.show()

def plot_boxplot_euclidean(context_child, generated_parent, context_parent):
    eu_1 = compute_euclidean_distance(generated_parent, context_child)
    eu_2 = compute_euclidean_distance(context_parent, context_child)
    ...
    plt.figure(figsize=(8, 6))
    # plt.boxplot([cosine_sim_1, cosine_sim_2], labels=['(Generated Parent, Context Child)', '(Context Parent, Context Child)'])
    plt.boxplot([eu_1, eu_2], labels=['$A$', '$B$'],
                showmeans=False, meanline=True, meanprops={'color': 'r', 'linestyle': '-', 'linewidth': 3},
                notch=False, patch_artist=False,
                boxprops=dict(linewidth=3),
                whiskerprops=dict(linewidth=3),
    ...
    plt.yticks(fontsize=14)
    plt.legend(fontsize=14, )
    plt.savefig('box_plot_euclidean.pdf', dpi=300, bbox_inches='tight')
    plt.show()

# ------------------------------------------------------------------
def plot_slope_graph_inclination(context_child, generated_parent, context_parent):
    in_1 = compute_inclination(generated_parent, context_child)
    in_2 = compute_inclination(context_parent, context_child)
    ...
    for i in sampled_indices:
        ...
        #     print(i)
        #     continue
        s_sim_1.append(in_1[i])
        s_sim_2.append(in_2[i])
    ...
    # Showing the plot
    plt.savefig('slope_graph_inclination.pdf', dpi=300, bbox_inches='tight')
    plt.show()


def plot_overlapping_density_inclination(context_child, generated_parent, context_parent):
    in_1 = compute_inclination(generated_parent, context_child)
    in_2 = compute_inclination(context_parent, context_child)
    ...
    # Plotting the density plots
    sns.kdeplot(in_1, label='(Generated Parent, Context Child)', shade=True, color="r", alpha=0.5)
    sns.kdeplot(in_2, label='(Context Parent, Context Child)', shade=True, color="b", alpha=0.5)
    ...
    plt.savefig('overlapping_density_inclination.pdf', dpi=300, bbox_inches='tight')
    plt.show()
...
def plot_violin_inclination(context_child, generated_parent, context_parent):
    ...
    # Plot violin plots
    plt.figure(figsize=(8, 6))
    plt.violinplot([in_1, in_2], showmeans=True)
    plt.xticks([1, 2], ['(Generated Parent, Context Child)', '(Context Parent, Context Child)'], fontsize=13)
    plt.yticks(fontsize=14)
...
def plot_box_plot_inclination(context_child, generated_parent, context_parent):
    in_1 = compute_inclination(generated_parent, context_child)
    in_2 = compute_inclination(context_parent, context_child)
    ...
    plt.figure(figsize=(8, 6))
    # plt.boxplot([cosine_sim_1, cosine_sim_2], labels=['(Generated Parent, Context Child)', '(Context Parent, Context Child)'])
    plt.boxplot([in_1, in_2], labels=['$A$', '$B$'],
                showmeans=False, meanline=True, meanprops={'color': 'r', 'linestyle': '-', 'linewidth': 3},
                notch=False, patch_artist=False,
                boxprops=dict(linewidth=3),
                whiskerprops=dict(linewidth=3),
    ...
    plt.yticks(fontsize=14)
    plt.legend(fontsize=14, )
    plt.savefig('box_plot_inclination.pdf', dpi=300, bbox_inches='tight')
    plt.show()
...
if __name__ == "__main__":
    ...
    # plot_overlapping_density(context_child, generated_parent, context_parent)
    # plot_violin_density(context_child, generated_parent, context_parent)
    ...
    # plot_violin_euclidean(context_child, generated_parent, context_parent)
    # plot_boxplot_euclidean(context_child, generated_parent, context_parent)

    # inclination
    # plot_slope_graph_inclination(context_child, generated_parent, context_parent)
    # plot_overlapping_density_inclination(context_child, generated_parent, context_parent)
    plot_violin_inclination(context_child, generated_parent, context_parent)
    # plot_box_plot_inclination(context_child, generated_parent, context_parent)
